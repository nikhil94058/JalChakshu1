        ...
        const timeObj = {
            ...
            'minutes':time.getMinutes()
                ...
                try
                {
                  ...
                  const query= await pool.query('INSERT INTO  videos_grievance (title , month, date, year,day ,hour, minutes,vid_data) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)',[timeObj.title,timeObj.month,timeObj.date,timeObj.year,timeObj.day,timeObj.hour,timeObj.minutes,base64String]);
