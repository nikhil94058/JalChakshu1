...
export default  function ModifyGrievance()
{
    ...
    const[data,setData] = useState({
        ...
        //On issue: you can check the value of the "message" key in the response "user" 
        ...
        const fet = async ()=>{
            ...
            console.log('grievacce):',grievance_data);
            // console.log("problem: ",user.message);
       ...
       useEffect(()=>{
        console.log("my newData: ",data);
        // console.log("grievancein useffect: ");
       },[data])
...
<Link href={"/modifyGrievance"+`/modifyImage/${data.img_id}/${data.g_id}`}>
...
<div>
   <Link href={`/modifyGrievance/modifyVideo/${data.vid_id}/${data.g_id}`}>
